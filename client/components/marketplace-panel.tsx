...
const MARKETPLACE_ADDRESS = process.env.NEXT_PUBLIC_MARKETPLACE_ADDRESS || '0x254e7a6971dfdd5bcd04f7a4a8fc541a35b6bde2';
const FACTORY_ADDRESS = process.env.NEXT_PUBLIC_FRACTIONAL_VAULT_FACTORY_ADDRESS || '0x93b67ae7c49e57a1c2c1b014f6db31180699573c';
