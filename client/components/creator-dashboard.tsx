...
export default function CreatorDashboard() {
  ...
  useEffect(() => {
    async function fetchEarnings() {
      ...
      try {
        ...
        console.warn(
          "Backend earnings fetch failed, showing seeded fallback data.",
        );
      }
    }
    fetchEarnings();
  ...
  const ownedWorks = [
    {
      id: "4",
      title: "Ancestral Rhythms Volume 3",
      category: "music",
      artist: "kwame.eth",
    },
    {
