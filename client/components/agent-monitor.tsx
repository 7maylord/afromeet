...
export default function AgentMonitor() {
  ...
  const [agentAddress, setAgentAddress] = useState<string>('0xf99337df8acbdce3221372ea41610d38b54ca33f');
  ...
  const fetchAgentStats = async () => {
    ...
    try {
      ...
      setAgentAddress(statusRes.wallet || '0xf99337df8acbdce3221372ea41610d38b54ca33f');
